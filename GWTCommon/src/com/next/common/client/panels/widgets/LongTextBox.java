...
public class LongTextBox extends VerticalPanel implements NextWidget,ChangeHandler{
	...
	public boolean validate() {
		...
		try{
			...
			if(t>= -9223372036854775808L && t <= 9223372036854775807L)
				returnValue = true;
			else
				returnValue = false;
		}catch(Exception ex)
	...
	public void onChange(ChangeEvent event) {
		if(event.getSource().equals(tb))
		{
			...
			else
			{
				...
				message.setText("Invalid Long Value");
			}
		}
	}
	@Override
